    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <svg viewBox="0 0 62 65" fill="none" class="h-6 w-auto bg-gray-100 dark:bg-gray-900">
                    <img src="{{ asset('images/mindcare.png') }}">
                </svg>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                MindCare is a multifunctional app that can be used for a lot of different purposes.
                            </p>
                        </div>
                    </a>
                    ...
                    <a
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Developers</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                This project has been done by Antonio Miguel Morales y Jose Pérez. </p>
                        </div>
                    </a>
                </div>
